...
def unet(pretrained_weights=None, input_size=(IMG_SIZE, IMG_SIZE, 1),num_class=2):
    ...
    up6 = Conv2D(512, 1, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(drop5))

    merge6 = concatenate([drop4, up6], axis=3)
    conv6 = Conv2D(512, 1, activation='relu', padding='same', kernel_initializer='he_normal')(merge6)
    ...
    up9 = Conv2D(64, 1, activation='relu', padding='same', kernel_initializer='he_normal')(
